                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['nama']; ?> <span class="font-weight-bold">(Koordinator)</span></span>
                                ...
                                ?>
                                    <img src="../assets/img/petugas/<?php echo $_SESSION['foto']; ?>" size="100" class="img-profile rounded-circle">
                                <?php
                                }
                                ?>
                            </a>
