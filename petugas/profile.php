...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            $id = $_SESSION['id'];
            $saya = mysqli_query($koneksi, "SELECT * FROM petugas WHERE id_petugas='$id'");
            ...
            <div class="card">
                <div class="d-flex flex-column align-items-center text-center p-3">
                    ...
                    ?>
                        <img src="../assets/img/petugas/<?php echo $s['foto']; ?>" class="img-profile rounded-circle" width="150">
                    <?php
                    }
                    ?>

                    <span class="font-weight-bold mt-3"><?php echo $_SESSION['nama']; ?></span><span class="text-black-50">Koordinator</span><span> </span>
                </div>
            </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="profile_act.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" class="form-control" name="nama" required="required" value="<?php echo $s['nama_petugas']; ?>">
                        </div>
