            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Koordinator</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php
                                $jumlah_petugas = mysqli_query($koneksi, "SELECT * FROM petugas");
                                echo mysqli_num_rows($jumlah_petugas);
                                ?>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Arsip Saya</div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                        <?php
                                        $jumlah_arsip = mysqli_query($koneksi, "SELECT * FROM arsip,petugas WHERE petugas_arsip=id_petugas AND id_petugas='$id'");
